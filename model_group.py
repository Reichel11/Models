...
Script for two different model configurations, which can be trained with automatic and manuel data augmentation. 
The scenes need to be enter as an array in x_train of size 
(number of scene, 224,2 24, 1). If the scenes are already augmented and ready for the training, 
